 ...
 * @author dexte
 */
public class adminIF extends javax.swing.JFrame {

    /**
     * Creates new form adminIF
     */
     
    public adminIF(String name, String username, String password) {
    ...
    private void initComponents() {
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/icons8-x-28.png"))); // NOI18N
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
        ...
        st.executeUpdate("UPDATE user SET name = '"+Name+"', username = '"+username+"', password = '"+pass+"' WHERE userT = 'Admin'");
        
            JOptionPane.showMessageDialog(new JFrame(), "Information Updated Succesfully");
        }catch(Exception e){
            e.printStackTrace();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(adminIF.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
